...
struct VehiclesData {
    static let countries = ["Afghanistan","Albania",
                               ...
                               "South Sudan","Spain", "Sri Lanka","Sudan (the)","Suriname","Svalbard and Jan Mayen", "Sweden", "Switzerland","Syrian Arab Republic","Taiwan", "Tajikistan",
    ...
    static let vehicleType = ["Hatchback", "Sedan", "Convertible", "Estate", "SUV", "Station wagon"]
    
    static let vehicleColor = ["black","blue","brown","cyan","gray","green","indigo","mint","orange","pink","purple","red","teal","white","yellow"]
    
    static var vehicleYear = ["1990"]
    
    static func toGetYear(){
        let date = Date()
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy"
        let yearString = dateFormatter.string(from: date)
        
        for year in 1991...Int(yearString)! {
            VehiclesData.vehicleYear.append(String(year))
        }
    }
    // MARK: - methods
